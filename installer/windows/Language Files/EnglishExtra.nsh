...
${LangFileString} FREOD_TEXT_GD_OLD "$\r$\n$\r$\nYour version of Geometry Dash is too old for this version of Freod!"
${LangFileString} FREOD_TEXT_MOD_LOADER_ALREADY_INSTALLED "This path has other mods installed!$\r$\nThey will be overwritten by Freod. (the dll trademark)"

; uninstaller

${LangFileString} FREOD_UNTEXT_FREOD_MISSING "This path does not have Freod installed!"
