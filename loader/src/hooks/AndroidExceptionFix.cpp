...
#endif
    auto vtable = reinterpret_cast<freod::cast::VtableType*>(*(intptr_t*)adjustedPtr);
    auto complete = static_cast<freod::cast::CompleteVtableType*>(vtable);
...
$execute {
    ...
    freod::cast::DummyClass dummyClass;
    auto vtable = reinterpret_cast<freod::cast::VtableType*>(*(intptr_t*)&dummyClass);
    auto complete = static_cast<freod::cast::CompleteVtableType*>(vtable);
    auto typeinfo = complete->m_typeinfo;
