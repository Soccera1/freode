...
namespace freod::addresser {
    ...
    class FREOD_DLL Addresser final {
        template <char C>
        ...
        static intptr_t addressOfVirtual(Return (Class::*func)(Parameters...)) {
            using freod::cast::reference_cast;
        ...
        static intptr_t addressOfNonVirtual(FnPtr func) {
            return followThunkFunction(freod::cast::reference_cast<intptr_t>(func));
        }
    ...
    inline Class thunkAdjust(Function func, Class self) {
        ...
        // why? bruh idk
        auto _ = *freod::cast::template union_cast<ptrdiff_t*>(&func);
