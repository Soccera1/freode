...
namespace freod {
    struct FREOD_DLL ColorProvidedEvent final : public Event {
        std::string id;
    ...
    class FREOD_DLL ColorProvidedFilter final : public EventFilter<ColorProvidedEvent> {
    public:
     ...
     * 
     * To help with this, Freod provides the `ColorProvider` class, which is 
     ...
     */
    class FREOD_DLL ColorProvider final {
    private:
        class Impl;
...
FREOD_HIDDEN inline cocos2d::ccColor4B operator""_cc4b_gd(const char* str, size_t) {
    return freod::ColorProvider::get()->color(str);
}
FREOD_HIDDEN inline cocos2d::ccColor3B operator""_cc3b_gd(const char* str, size_t) {
    return freod::ColorProvider::get()->color3b(str);
}
FREOD_HIDDEN inline cocos2d::ccColor4B operator""_cc4b(const char* str, size_t) {
    return freod::ColorProvider::get()->color(std::string(freod::Mod::get()->expandSpriteName(str)));
}
FREOD_HIDDEN inline cocos2d::ccColor3B operator""_cc3b(const char* str, size_t) {
    return freod::ColorProvider::get()->color3b(std::string(freod::Mod::get()->expandSpriteName(str)));
}
