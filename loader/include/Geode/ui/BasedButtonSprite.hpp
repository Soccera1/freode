...
namespace freod {
    ...
    FREOD_DLL const char* baseEnumToString(CircleBaseSize);
    ...
    enum class CircleBaseColor {
        ...
        Blue = 3,
        Cyan = 4,
        DarkPurple = 5, // Freod-added color, used in Freod UIs
        DarkAqua = 6,   // Freod-added color, used in Freod UIs
    };
    FREOD_DLL const char* baseEnumToString(CircleBaseColor);

    enum class CrossBaseSize {
        Small = 0,  // the size of the icon kit / create button
        Huge = 1,   // the size of the play button
    };
    FREOD_DLL const char* baseEnumToString(CrossBaseSize);

    enum class CrossBaseColor {
        Green = 0,
    };
    FREOD_DLL const char* baseEnumToString(CrossBaseColor);

    enum class AccountBaseSize {
        Normal = 0,
    };
    FREOD_DLL const char* baseEnumToString(AccountBaseSize);
    ...
    FREOD_DLL const char* baseEnumToString(AccountBaseColor);

    enum class IconSelectBaseSize {
        Normal = 0,
    };
    FREOD_DLL const char* baseEnumToString(IconSelectBaseSize);

    enum class IconSelectBaseColor {
        Unselected = 0,
        Selected = 1,
    };
    FREOD_DLL const char* baseEnumToString(IconSelectBaseColor);

    enum class EditorBaseSize {
        Normal = 0,
    };
    FREOD_DLL const char* baseEnumToString(EditorBaseSize);
    ...
    FREOD_DLL const char* baseEnumToString(EditorBaseColor);

    enum class TabBaseSize {
        Normal = 0,
    };
    FREOD_DLL const char* baseEnumToString(TabBaseSize);
    ...
    FREOD_DLL const char* baseEnumToString(TabBaseColor);

    enum class LeaderboardBaseSize {
        Normal = 0,
    };
    FREOD_DLL const char* baseEnumToString(LeaderboardBaseSize);

    enum class LeaderboardBaseColor {
        Blue = 0,
    };
    FREOD_DLL const char* baseEnumToString(LeaderboardBaseColor);

    enum class CategoryBaseSize {
        Big = 0,
    };
    FREOD_DLL const char* baseEnumToString(CategoryBaseSize);

    enum class CategoryBaseColor {
        Green = 0,
    };
    FREOD_DLL const char* baseEnumToString(CategoryBaseColor);
    ...
    FREOD_DLL const char* baseEnumToString(BaseType);
     ...
     */
    class FREOD_DLL BasedButtonSprite : public cocos2d::CCSprite {
    protected:
        BaseType m_type;
        int m_size;
        int m_color;
     ...
     */
    class FREOD_DLL CircleButtonSprite : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class FREOD_DLL CrossButtonSprite : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class FREOD_DLL AccountButtonSprite : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class FREOD_DLL IconSelectButtonSprite : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class FREOD_DLL LeaderboardButtonSprite : public BasedButtonSprite {
    public:
     ...
     */
    class FREOD_DLL EditorButtonSprite : public BasedButtonSprite {
    public:
     ...
     */
    class FREOD_DLL TabButtonSprite : public BasedButtonSprite {
    public:
     ...
     * CreatorLayer
     */
    class FREOD_DLL CategoryButtonSprite : public BasedButtonSprite {
    public:
